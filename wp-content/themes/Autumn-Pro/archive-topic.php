...
<div class="page-banner" style="background: url(<?php echo wpjam_theme_get_setting('topic_bg_img');?>);background-position: center center;-webkit-background-size: cover;background-size: cover;">
	<div class="dark-overlay"></div>
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="page-content" style="text-align: left;">
					<h2><?php echo wpjam_theme_get_setting('topic_title');?></h2>
					<p class="text-muted lead">
						<?php echo wpjam_theme_get_setting('topic_ms');?>
					</p>
				</div>
			</div>
		</div>
