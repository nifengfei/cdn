...
window.lazySizesConfig = window.lazySizesConfig || {}, window.lazySizesConfig.loadHidden = !1, jQuery(function() {
	"use strict";
	retinaLogo(), hero(), featuredPosts(), categoryBoxes(), offCanvas(), megaMenu(), instagramSlider(), gallery(), explore(), picks(), fitVids(), search(), stickySidebar(), bookmark(), share(), layout()
