...
if($_POST['action'] == 'WPJAM_XinTheme_captcha' && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
...
function sessioncode($email){
	...
	$_SESSION['WPJAM_XinTheme_autumn_captcha']=strtolower($_dscode);
	$_SESSION['WPJAM_XinTheme_autumn_captcha_email']=$email;
	$message .= '验证码：'.$_dscode;   
