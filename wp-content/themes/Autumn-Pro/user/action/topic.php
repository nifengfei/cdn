<div class="wp-editor col-lg-9">
	...
	<div class="tougao">
		...
		<form action="<?php echo home_url('user/topic'); ?>" method="POST" id="post_form">
		<div class="tougao-editor">
			<b>输入标题</b>
			<h2 style="margin-top: 15px"><input name="topic_title" class="topic_title" type="text" placeholder="请输入标题..." value="<?php echo $post_title;  ?>" required="required"></h2>
		</div>
		...
		<div class="content-editor">
			...
			<div class="upload_img_wrap" style="display:none"><!-- 暂时隐藏 -->
				<div id="imgBox"></div>
