	...
	<?php if( is_user_logged_in() ){?>
		...
		<div id="comments" class="comments-area">
			...
			<?php
				$comments_args = array(
					'title_reply' => '发表评论',
					'logged_in_as' => '<p class="logged-in-as">' . sprintf( __( '当前登陆账号为：<a href="%1$s">%2$s</a>，<a href="%3$s" title="退出登陆?">退出登陆?</a>' ), admin_url( 'profile.php' ), $user_identity, wp_logout_url( apply_filters( 'the_permalink', get_permalink( ) ) ) ) . '</p>',
					'label_submit' => '发表评论',
				);
