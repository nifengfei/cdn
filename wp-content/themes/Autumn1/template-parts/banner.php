...
<?php
	...
	if($slide_type == 'img_one'){
?>
<?php if(wp_is_mobile()){?>
	<div class="hero banner-one lazyload visible" data-bg="<?php if( wpjam_theme_get_setting('img_one_url_mb') ){ echo wpjam_theme_get_setting('img_one_url_mb'); }else{ echo wpjam_theme_get_setting('img_one_url'); }?>">
<?php }else{?>
	<div class="hero banner-one lazyload visible" data-bg="<?php echo wpjam_theme_get_setting('img_one_url');?>">
<?php }?>
	<div class="container">
...
<div class="autumn_module_slider_center">
	<div class="container">
		<div class="module slider center owl">
			...
			<article class="post lazyload" data-bg="<?php echo wpjam_get_post_thumbnail_url($post, $size, $crop);?>">
